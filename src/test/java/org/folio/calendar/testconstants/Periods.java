...
public class Periods {
  ...
  public static final Period PERIOD_FULL_EXAMPLE_F = PERIOD_2021_01_01_TO_2021_04_30
    .withId(UUIDs.UUID_A)
    .withServicePointId(UUIDs.UUID_0)
    .withName(Names.NAME_1)
    .withOpeningDays(
  ...
  public static final Period PERIOD_FULL_EXAMPLE_G = PERIOD_2021_05_01_TO_2021_09_22
    .withId(UUIDs.UUID_B)
    .withServicePointId(UUIDs.UUID_0)
    .withName(Names.NAME_2)
    .withOpeningDays(
  ...
  public static final Period PERIOD_FULL_EXCEPTIONAL_E = PERIOD_2021_01_01_TO_2021_01_04
    .withId(UUIDs.UUID_E)
    .withServicePointId(UUIDs.UUID_0)
    .withName(Names.NAME_1)
    .withOpeningDays(Arrays.asList(OpeningDayRelativeConstants.EXCEPTIONAL_CLOSED));

  public static final Period PERIOD_FULL_EXCEPTIONAL_F = PERIOD_2021_03_16_TO_2021_04_30
    .withId(UUIDs.UUID_F)
    .withServicePointId(UUIDs.UUID_0)
    .withName(Names.NAME_2)
    .withOpeningDays(Arrays.asList(OpeningDayRelativeConstants.EXCEPTIONAL_OPEN_ALL_DAY));

  public static final Period PERIOD_FULL_EXCEPTIONAL_G = PERIOD_2021_07_04_TO_2021_09_22
    .withId(UUIDs.UUID_0)
    .withServicePointId(UUIDs.UUID_0)
    .withName(Names.NAME_3)
    .withOpeningDays(Arrays.asList(OpeningDayRelativeConstants.EXCEPTIONAL_CLOSED));
