...
DROP SCHEMA
  IF EXISTS "test_mod_calendar" CASCADE;

CREATE SCHEMA
  "test_mod_calendar";

CREATE TABLE
  "test_mod_calendar"."exceptional_hours" (
    "id" uuid NOT NULL,
...
CREATE TABLE
  "test_mod_calendar"."regular_hours" (
    "id" uuid NOT NULL,
    "jsonb" jsonb NOT NULL,
    "creation_date" timestamp,
    "created_by" text,
...
CREATE TABLE
  "test_mod_calendar"."rmb_internal" (
    "id" integer NOT NULL,
    "jsonb" jsonb NOT NULL,
