...
public class OpeningHoursService {
   ...
   */
  protected List<DataConflictException> validateServicePointConflicts(
   ...
   */
  protected Optional<InvalidDataException> validateCalendarName(Calendar calendar) {
   ...
   * @return an InvalidDataException, if one has occurred
   */
  protected Optional<InvalidDataException> validateCalendarDates(Calendar calendar) {
   ...
   */
  protected Optional<InvalidDataException> validateNormalOpenings(Set<NormalOpening> normalHours) {
   ...
   */
  protected Optional<InvalidDataException> validateExceptionRangeNames(Set<ExceptionRange> ranges) {
   ...
   * failed.
   */
  protected Optional<List<InvalidDataException>> validateExceptionRangeDateOrder(
   ...
   * occurred.
   */
  protected Optional<List<InvalidDataException>> validateExceptionRangeDateBounds(
    Calendar calendar,
    Set<ExceptionRange> ranges
  ) {
    List<ExceptionRange> failed = ranges
   ...
   */
  protected Optional<InvalidDataException> validateExceptionRangeOverlaps(
